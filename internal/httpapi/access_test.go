...
func TestDeliveryRoutesAreClosedByDefault(t *testing.T) {
	...
	closed := []struct{ method, path string }{
		...
		{http.MethodGet, "/critical-services"},
		{http.MethodPost, "/critical-services"},
		{http.MethodGet, "/critical-services/svc"},
		{http.MethodPatch, "/critical-services/svc"},
		{http.MethodDelete, "/critical-services/svc"},
		{http.MethodPost, "/critical-services/svc/webhook-token"},
		{http.MethodGet, "/critical-settings"},
		{http.MethodPatch, "/critical-settings"},
