...
/// A warning's label: a rotated square ahead of the word. Neon yellow on the
/// dark ground; on the light ground the pair becomes a chip, `onField` ink on
/// yellow, because neon yellow does not read on the light paper.
...
/// light ground it sits as `onField` ink on a yellow pad, because neon yellow
/// does not read on the light paper. Blinks in hard steps when asked to,
